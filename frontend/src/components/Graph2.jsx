...
const Graph2 = ({ data }) => {
  useEffect(() => {
    ...
    // You can access the 'data' prop here and update the graph accordingly
  }, [data]);
...
<p>
  ...
  <a href="https://gojs.net/latest/samples/PERT.html">PERT.html</a>. It was automatically generated from a button on the sample page,
  and does not contain the full HTML. It is intended as a starting point to adapt for your own usage.
  For many samples, you may need to inspect the
  <a href="https://github.com/NorthwoodsSoftware/GoJS/blob/master/samples/PERT.html">full source on Github</a>
